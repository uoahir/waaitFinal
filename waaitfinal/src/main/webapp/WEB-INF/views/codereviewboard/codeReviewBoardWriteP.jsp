...
<section class="section">
	<div class="card d-flex align-items-center" id="title">
		<h1>Write</h1>
	</div>

	<div class="card " id="code-board" style="height: 1000px">
		<form action="${path }/codereviewboard/insert" enctype="multipart/form-data" method="post">
			<div><p>제목: <input type="text" name="codeBoardTitle"/></p></div>
			
			<textarea  class="form-control"	id="exampleFormControlTextarea1" rows="20" cols="" placeholder="plz in code" name="codeContent"></textarea>
			  <div class="">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            ...
                            <!-- Basic file uploader -->
                            <input type="file" class="basic-filepond" name="upFile">
                        </div>
                    </div>
                </div>
            </div>
			...
			<div class="d-flex mt-4">
				<select class="choices form-select" name="codeType">
					<option value="null">언어선택</option>
				...
				<select class="choices form-select" name="developmentType">
					<option value="null">개발분야</option>
			...
			<div class="card mt-4">
			<textarea  class="form-control"	id="exampleFormControlTextarea1" rows="3" cols="" placeholder="comment" name="codeReviewComment"></textarea>
			</div>
			<input  class="btn btn-Success" style="float: right;" type="submit" value="작성">
		</form>
