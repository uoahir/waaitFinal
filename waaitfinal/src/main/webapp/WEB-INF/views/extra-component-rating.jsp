...
<link rel="stylesheet" href="${path }/resources/assets/extensions/rater-js/lib/style.css">
...
<script src="${path }/resources/assets/extensions/rater-js/index.js?v=2"></script>
<script src="${path }/resources/assets/static/js/pages/rater-js.js"></script>
