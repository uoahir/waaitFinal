...
<link rel="stylesheet" href="${path }/resources/assets/extensions/simple-datatables/style.css">

  <link rel="stylesheet" crossorigin href="${path }/resources/assets/compiled/css/table-datatable.css">
...
<script src="${path }/resources/assets/extensions/simple-datatables/umd/simple-datatables.js"></script>
<script src="${path }/resources/assets/static/js/pages/simple-datatables.js"></script>
