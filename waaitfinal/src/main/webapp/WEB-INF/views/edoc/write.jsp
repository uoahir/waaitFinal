...
<%@ page import = "com.waait.dto.Type"  %>

<jsp:include page= "${path}/WEB-INF/views/common/header.jsp"/>
<%-- <%@ include file="/WEB-INF/views/common/header.jsp"%> --%>
<%-- <%@ include file="/WEB-INF/views/common/sideBar.jsp"%> --%>
<%-- <jsp:include page="/WEB-INF/views/edoc/edocSideBar.jsp">
</jsp:include> --%>
<!-- Main Content -->
												...
												<table class="table" id="detail_table">
													<tbody>
														<tr>
															...
															<th>작성자</th>
															<td>
																<c:out value="${employee.department.deptName }"/> <c:out value="${emp.JOBNAME }"/> <c:out value="${emp.EMPNAME }"/>
