...
<link rel="stylesheet" href="${path }/resources/assets/extensions/datatables.net-bs5/css/dataTables.bootstrap5.min.css">

  <link rel="stylesheet" crossorigin href="${path }/resources/assets/compiled/css/table-datatable-jquery.css">
...
<script src="${path }/resources/assets/extensions/datatables.net/js/jquery.dataTables.min.js"></script>
<script src="${path }/resources/assets/extensions/datatables.net-bs5/js/dataTables.bootstrap5.min.js"></script>
<script src="${path }/resources/assets/static/js/pages/datatables.js"></script>
