...
<link rel="stylesheet" href="${path }/resources/assets/extensions/sweetalert2/sweetalert2.min.css">

  <link rel="stylesheet" crossorigin href="${path }/resources/assets/compiled/css/extra-component-sweetalert.css">
...
<script src="${path }/resources/assets/extensions/sweetalert2/sweetalert2.min.js"></script>>
<script src="${path }/resources/assets/static/js/pages/sweetalert2.js"></script>>
