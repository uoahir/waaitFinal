...
<link rel="stylesheet" href="${path }/resources/assets/extensions/choices.js/public/assets/styles/choices.css">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="alert alert-light-primary">
                                        <a href="https://github.com/Choices-js/Choices" target="_blank">Click
...
<script src="${path }/resources/assets/extensions/choices.js/public/assets/scripts/choices.js"></script>
<script src="${path }/resources/assets/static/js/pages/form-element-select.js"></script>
