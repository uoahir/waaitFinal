...
<link rel="stylesheet" href="${path }/resources/assets/extensions/dragula/dragula.min.css">

  <link rel="stylesheet" crossorigin href="${path }/resources/assets/compiled/css/ui-widgets-todolist.css">
                                ...
                                <div
                                    ...
                                    <div class="widget-todo-item-action d-flex align-items-center">
                                        ...
                                        <div class="avatar bg-warning">
                                            <img src="${path }/resources/assets/compiled/jpg/1.jpg" alt="" srcset="">
                                        </div>
                            ...
                            <li class="widget-todo-item">
                                <div
                                    ...
                                    <div class="widget-todo-item-action d-flex align-items-center">
                                        ...
                                        <div class="avatar bg-warning">
                                            <img src="${path }/resources/assets/compiled/jpg/2.jpg" alt="" srcset="">
                                        </div>
                                        <i class="bx bx-dots-vertical-rounded font-medium-3 cursor-pointer"></i>
                                    </div>
                                </div>
                                ...
                                <div
                                    ...
                                    <div class="widget-todo-item-action d-flex align-items-center">
                                        ...
                                        <div class="avatar bg-rgba-primary m-0 me-50">
                                            <img src="${path }/resources/assets/compiled/jpg/3.jpg" alt="" srcset="">
                                        </div>
                                        <i class="bx bx-dots-vertical-rounded font-medium-3 cursor-pointer"></i>
                                    </div>
                                </div>
                            ...
                            <li class="widget-todo-item">
                                <div
                                    ...
                                    <div class="widget-todo-item-action d-flex align-items-center">
                                        ...
                                        <div class="avatar bg-warning">
                                            <img src="${path }/resources/assets/compiled/jpg/4.jpg" alt="" srcset="">
                                        </div>
                                        <i class="bx bx-dots-vertical-rounded font-medium-3 cursor-pointer"></i>
                                    </div>
                                </div>
                            ...
                            <li class="widget-todo-item">
                                <div
                                    ...
                                    <div class="widget-todo-item-action d-flex align-items-center">
                                        ...
                                        <div class="avatar bg-warning">
                                            <img src="${path }/resources/assets/compiled/jpg/5.jpg" alt="" srcset="">
                                        </div>
                                        <i class="bx bx-dots-vertical-rounded font-medium-3 cursor-pointer"></i>
                                    </div>
                                </div>
...
<script src="${path }/resources/assets/extensions/dragula/dragula.min.js"></script>
<script src="${path }/resources/assets/static/js/pages/ui-todolist.js"></script>
