...
<link rel="stylesheet" href="${path }/resources/assets/extensions/jsvectormap/css/jsvectormap.min.css"/>
...
<script src="${path }/resources/assets/extensions/jsvectormap/js/jsvectormap.min.js"></script>
<script src="${path }/resources/assets/extensions/jsvectormap/maps/world.js"></script>
<script src="${path }/resources/assets/static/js/pages/jsvectormap.js"></script>
