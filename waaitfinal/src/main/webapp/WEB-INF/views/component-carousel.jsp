            ...
            <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
              <div class="carousel-inner">
                <div class="carousel-item active">
                  <img src="${path }/resources/assets/compiled/jpg/building.jpg" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                  <img src="${path }/resources/assets/compiled/jpg/architecture1.jpg" class="d-block w-100" alt="...">
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="card">
          ...
          <div class="card-body">
            <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
              ...
              <div class="carousel-inner">
                <div class="carousel-item active">
                  <img src="${path }/resources/assets/compiled/png/1.png" class="d-block w-100" alt="...">
                ...
                <div class="carousel-item">
                  <img src="${path }/resources/assets/compiled/png/2.png" class="d-block w-100" alt="...">
                  <div class="carousel-caption d-none d-md-block">
                ...
                <div class="carousel-item">
                  <img src="${path }/resources/assets/compiled/png/3.png" class="d-block w-100" alt="...">
                  <div class="carousel-caption d-none d-md-block">
        ...
        <div class="card">
          ...
          <div class="card-body">
            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
              <div class="carousel-inner">
                <div class="carousel-item active">
                  <img src="${path }/resources/assets/compiled/jpg/banana.jpg" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                  <img src="${path }/resources/assets/compiled/jpg/bg-mountain.jpg" class="d-block w-100" alt="...">
                </div>
              </div>
