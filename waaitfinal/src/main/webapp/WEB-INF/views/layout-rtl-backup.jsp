...
<head>
    ...
    <link rel="stylesheet" href="${path }/resources/assets/compiled/css/app.rtl.css">
    <link rel="stylesheet" href="${path }/resources/assets/compiled/css/app-dark.rtl.css">
                                ...
                                <div class="col-6">
                                    <div class="d-flex align-items-center">
                                        <svg class="bi text-primary" width="32" height="32" fill="blue"
                                            style="width:10px">
                                            <use
                                                xlink:href="${path }/resources/assets/static/images/bootstrap-icons.svg#circle-fill" />
                                        </svg>
