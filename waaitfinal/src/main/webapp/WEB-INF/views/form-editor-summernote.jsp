...
<link rel="stylesheet" href="${path }/resources/assets/extensions/summernote/summernote-lite.css">
  ...
  <link rel="stylesheet" crossorigin href="${path }/resources/assets/compiled/css/form-editor-summernote.css">
...
<script src="${path }/resources/assets/static/js/pages/summernote.js"></script>
