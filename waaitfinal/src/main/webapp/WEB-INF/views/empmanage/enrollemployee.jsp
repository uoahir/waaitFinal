...
<title>Account Profile - Mazer Admin Dashboard</title>
...
<body>
				...
				<section class="section">
					<div class="row">
								...
								<div class="card-body">
									<div
										...
										<div class="avatar avatar-2xl">
											<img src="${path }/resources/assets/compiled/jpg/2.jpg" alt="Avatar">
										</div>
						...
						<div class="col-12 col-lg-8">
							<div class="card">
								<div class="card-body">
									<form action="${path }/manage/enrollemployee.do" method="POST" enctype="multipart/form-data" onsubmit="return beforeEnrollEmployee()">
										...
										<div class="form-group">
											<label for="empEmail" class="form-label">사내메일주소</label> 
											<input type="text" name="empEmail" id="empEmail" class="form-control" disabled required>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											<label for="empAddress" class="form-label">주소</label><br>
											<input type="radio" name="selectAddressMethod" id="directCheck" value="direct">직접입력
											<input type="radio" name="selectAddressMethod" id="usingApiCheck" value="usingApi" style="margin-left:10px">우편번호로 찾기
											<span id="alertAddressSelect" hidden="true">선택해주세요!</span>
											<div id="joinAddressByApi" hidden="true">
												<input type="text" id="sample2_postcode" placeholder="우편번호">
												<input type="button" onclick="sample2_execDaumPostcode()" value="우편번호 찾기"><br>
												<input type="text" name="roadAddress" id="sample2_address" placeholder="주소"><span id="alertUsingApi" hidden="true">입력란을 채워주세요</span><br>
											...
											<div id="directWriteAddress" hidden="true">
												<input type="text" name="empAddress" id="empAddress" placeholder="주소 입력" class="form-control">
											</div>
											<script>
												...
												document.getElementById("engName").addEventListener("blur", e => {
													document.getElementById("empEmail").value = e.currentTarget.value + "@waait.com";
												});
										...
										<div class="form-group">
											...
											<input type="date" name="empBirth" id="empBirth" class="form-control" placeholder="Your Birthday" required>
										</div>
										<div class="form-group">
											<label for="empGender" class="form-label">성별</label> 
											<select name="empGender" id="empGender" class="form-control" required>
												<option value="m">남성</option>
												<option value="f">여성</option>
											</select>
										</div>
										<div class="form-group">
											<label for="signfile" class="form-label">Sign 파일</label>
										...
										<div class="form-group">
											...
											<button type="submit" class="btn btn-primary margin-left-button">등록하기</button>
										</div>
	...
	<script>
	    ...
	    console.log(document.getElementById("noDeptOption"));
	</script>
