...
<link rel="stylesheet" href="${path }/resources/assets/extensions/@icon/dripicons/dripicons.css">

  <link rel="stylesheet" crossorigin href="${path }/resources/assets/compiled/css/ui-icons-dripicons.css">
