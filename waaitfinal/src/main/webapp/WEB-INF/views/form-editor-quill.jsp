...
<link rel="stylesheet" href="${path }/resources/assets/extensions/quill/quill.snow.css">
<link rel="stylesheet" href="${path }/resources/assets/extensions/quill/quill.bubble.css">
...
<script src="${path }/resources/assets/extensions/quill/quill.min.js"></script>
<script src="${path }/resources/assets/static/js/pages/quill.js"></script>
