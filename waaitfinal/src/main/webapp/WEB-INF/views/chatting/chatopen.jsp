...
<body>
		        ...
		        <div id="chatting_aside">
		            <div id="chatting_aside_icon_area">
		               ...
		               <!--  <div class="chatting_aside_icon">
		                ...
		                <!-- 
		                	채팅방 추가
		                	그룹, 오픈 채팅방 선택하는창 만들기 -> 모달? 일꺼같음
		                	div 한테 onclick 이벤트
		                	선택하면 오른쪽창을 ajax 화면 변경
		                	그룹은 사용자목록 뼈대 가져와서 만들고, 오픈은 새로 가볍게 만들기
		                	사원 선택 (체크박스 밸류에 각 사원번호), (input태그) 작성 후 확인버튼 누르면 방 생성 하면서
		                	채팅방 창 띄우기
		                 -->
		                    <button onclick="chatinvitation();">
		...
		<div id="chatting_main_content">
			...
			<main>
		        ...
		        <div id="chatting_userlist">
		            ...
		            <!-- 사용자 목록 -->
		            <div id="chatting_userlist_printarea_all_headline">
		            	<h2>사원 목록</h2>
		            </div>
		            ...
		            </div>	<!-- chatting_userlist_printarea_all 끝 -->
	...
	<div id="modal_chatinvitation">
		<div>
			<div>
				<p id="modal_chatinvitation_groupchat">일반채팅</p>
			</div>
			<!-- <div>
				<p id="modal_chatinvitation_openchat">오픈채팅</p>
			</div> -->
		</div>
	</div>
	...
	<div id="modal_empprofile">
		<div>
			...
			<div id="modal_empprofile_top">
				<div>
					<!-- 닫기버튼 -->
					<button onclick="modalempprofileclose();">✕</button>
				</div>
				<div>
					<!-- 프로필 -->
